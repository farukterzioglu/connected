...
namespace Connected.Common
{
    ...
    public class TriggerManager
    {
        ...
        private static TriggerManager _triggerManager;

        //'Type'-'Trigger List' Dictionary 
        private readonly Dictionary<Type, List<ITrigger>> _triggers = new Dictionary<Type, List<ITrigger>>();
        ...
        /// <returns></returns>
        public List<T> GetTriggers<T>() where T : ITrigger
        {
            if (_triggers.ContainsKey(typeof (T)))
            {
                List<T> triggers = _triggers[typeof(T)].Select(x => (T)x).ToList();
                return triggers;
            }
            return null;
        }
        ...
        /// <summary>
        /// Initialize triggers by type, filters 'list' by T
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <summary>
        /// Initialize triggers, 
        /// Logs to console; trigger methods (base and overriden), initilized class name
        /// </summary>
        /// <param name="list"></param>
        ...
        /// <summary>
        /// Clears trigger list, dispose all initialized trigger classes  (call to dispose)
        /// </summary>
